...
# Download and update installed asustor_smart_info

set -Eeuo pipefail

FILENAME="asustor_smart_info.sh"
...
wget -q https://raw.githubusercontent.com/007revad/Asustor_SMART_info/refs/heads/main/$FILENAME -O $TMP_FILENAME
